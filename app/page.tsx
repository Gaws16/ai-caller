      ...
      <section className="relative overflow-hidden bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800">
        ...
        <div className="container relative mx-auto px-4 py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 max-w-3xl mx-auto mb-8 animate-in fade-in slide-in-from-bottom-6 duration-1000" style={{ animationDelay: '200ms', animationFillMode: 'backwards' }}>
              Access premium tools and apps that transform how you work, create, and grow.
              Start your free trial today.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom-8 duration-1000" style={{ animationDelay: '400ms', animationFillMode: 'backwards' }}>
